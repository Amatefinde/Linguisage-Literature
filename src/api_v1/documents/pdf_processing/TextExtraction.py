...
#
# from src.core.config import static_path as static_path_default
# from src.api_v1.crud import LiteratureDAO
# from os import path
...
#             fullpath = (
#                 path.join(static_path, literature_number)
#                 + "_"
...
#                 image_path="static\\literature_pages\\"
#                 + literature_number
#                 + "_"
#                 + str(page.page_number)
#                 + ".jpeg",
...
#     async def main():
#         with open(
#             r"E:\all\studying\Linguisage-Content\app\static\literature_original\16.pdf",
#             "rb",
#         ) as file:
